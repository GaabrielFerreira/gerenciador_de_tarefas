...
def gerar_arquivo_crescente(nome, quantidade):
    with open(nome, "w") as f:
        por_prioridade = quantidade // 5
        id_atual = 1

        for prioridade in range(1, 6):  # 1 a 5
...
if __name__ == "__main__":
    ...
    for tam in tamanhos:
        gerar_arquivo_crescente(f"tarefas_crescente_{tam}.txt", tam)
    print("Arquivos CRESCENTES gerados com sucesso!")